...
// CONCATENATED MODULE: ./packages/table/src/store/index.html.js
  ...
  methods: {
    ...
    wrappedRowRender: function wrappedRowRender(row, $index) {
      ...
      if (this.hasExpandColumn && isRowExpanded(row)) {
        ...
        // 渲染嵌套数据
        if (cur) {
          // currentRow 记录的是 index.html，所以还需主动增加 TreeTable 的 index.html
          var i = 0;
...
// CONCATENATED MODULE: ./packages/table/index.html.js
